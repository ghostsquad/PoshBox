# Build a dynamic assembly with a single module
$IndentedDnsMB = New-DynamicModuleBuilder "Indented.Dns" -UseGlobalVariable $false

# Enumerations
Import-Module $psscriptroot\Enum.ps1

# Resolver (Message)
Import-Module $psscriptroot\Message.ps1
Import-Module $psscriptroot\MessageResourceRecord.ps1
Import-Module $psscriptroot\MessageCmdLets.ps1

# Active Directory
Import-Module $psscriptroot\ADResourceRecord.ps1
Import-Module $psscriptroot\ADCmdLets.ps1

# WMI
Import-Module $psscriptroot\Wmi.ps1
Import-Module $psscriptroot\WmiResourceRecord.ps1
Import-Module $psscriptroot\WmiCmdLets.ps1
...
New-Variable IndentedDnsTCEndFound -Scope Script -Value $false

# SIG # Begin signature block
# MIIPkQYJKoZIhvcNAQcCoIIPgjCCD34CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUDrCGgPrXVTPF48Weq3tKJ1/c
# 5JagggzGMIIGTjCCBTagAwIBAgICDfcwDQYJKoZIhvcNAQELBQAwgYwxCzAJBgNV
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFEUl
# DT5B2oDgFkk8HrNVl/33BlwrMA0GCSqGSIb3DQEBAQUABIIBAGPCXBAHtVxRV6Sm
# vTFMnA9zDcRnCIyCt+ZNafJr3oIQJVlyfsKkG+ogf4LDxougO3FH5GpenjKpUIuL
# cwTbaIDZxnv+FQMr66SbTvg9SxXbCcSA/HN7uHXHSYRBQ+NMQYakAOH76Wkk9riJ
# cB98qNpm1C+qT5yLmnYs3tLcNnS+MFY6a6ILUXfNerCaQZ84HD60ApMpBtgr3N8Z
# HhQJiPjF47ws+KnRRKiWc+TuLCzNTYVvvdPcnMD/OY1ubYtUH4og8nfTqRnGx4fe
# UNGbBRtGHymfdjAKXF22vRvAEPYiqrCC3RfwY7LiSmrNfDIwZ9DUm6yeNEe3f3l2
# bW6pqY4=
